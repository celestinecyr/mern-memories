...
export const likePost = async(req, res) => {
    ...
    const updatedPost = await PostMessage.findByIdAndUpdate(id, { likeCount: post.likeCount + 1}, { new:true });                  //* in the 2nd param we wanna pass in our updates. so thats gg to be an object & in there we increment the like count || 3rd param, new = true
